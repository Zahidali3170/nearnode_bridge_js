...
export declare const TRANSFER_TYPE = "@near-eth/near-ether/natural-ether/sendToNear";
 ...
 */
export declare function recover(lockTxHash: string, options?: TransferOptions): Promise<Transfer>;
/**
