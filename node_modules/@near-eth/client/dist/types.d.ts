...
export interface TransferStatus {
    ...
    status: typeof IN_PROGRESS | typeof ACTION_NEEDED | typeof COMPLETE | typeof FAILED;
}
 ...
 */
export declare type Transfer = UnsavedTransfer & {
    id: string;
};
export declare type DecoratedTransfer = Transfer & {
    error?: string;
